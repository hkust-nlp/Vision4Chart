...
if __name__ == '__main__':
    ...
    model = LlavaNextForConditionalGeneration.from_pretrained("/project/deemreason/junteng/Vision4Math/data/llava-v1.6-vicuna-13b-hf", torch_dtype=torch.float16, low_cpu_mem_usage=True)
    model = model.to(device=DEVICE)

    processor = LlavaNextProcessor.from_pretrained("/project/deemreason/junteng/Vision4Math/data/llava-v1.6-vicuna-13b-hf")
    model.eval()
