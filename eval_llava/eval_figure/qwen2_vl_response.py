...
if __name__ == '__main__':
    ...
    "/project/deemreason/junteng/Vision4Math/data/Qwen2-VL-7B-Instruct", torch_dtype="auto", device_map="auto"
)
    model = model.to(device=DEVICE)

    processor = AutoProcessor.from_pretrained("/project/deemreason/junteng/Vision4Math/data/Qwen2-VL-7B-Instruct")
    model.eval()
