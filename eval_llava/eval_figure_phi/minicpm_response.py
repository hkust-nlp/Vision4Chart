...
if __name__ == '__main__':
    ...
    model = AutoModel.from_pretrained('data/minicpm', trust_remote_code=True, torch_dtype=torch.float16)
    model = model.to(device='cuda')

    tokenizer = AutoTokenizer.from_pretrained('data/minicpm', trust_remote_code=True)
    model.eval()
